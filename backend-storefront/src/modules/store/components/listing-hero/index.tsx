    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(93,46,70,0.07) 0%, transparent 70%)",
            right: "-5%",
            top: "-20%",
            animation: "listing-hero-orb 20s ease-in-out infinite",
          }}
        />
        <div
          ...
          style={{
            ...
            bottom: "-15%",
            animation:
              "listing-hero-orb 25s ease-in-out infinite reverse",
          }}
        />
      </div>
      <style>{`@keyframes listing-hero-orb { 0%, 100% { transform: translate3d(0,0,0) scale(1); } 50% { transform: translate3d(30px,-20px,0) scale(1.1); } }`}</style>
